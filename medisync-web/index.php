...
<body>
  ...
  <section id="home">
    <div class="overlay">
      ...
      <p>Empowering you with personalized health insights and technology-driven recommendations for a healthier tomorrow.</p>
      <?php
        if(isset($_SESSION['fname'])){
          echo '<a href="choice.php" class="cta-btn">Get Started</a>';
        }
        else{
